...
Generalized Focal Loss (GPL) combines classification and regression to provide one score

$L_{QFL}$ and $L_{DFL}$ are the Quality and Distributed Focal losses respectively. $L_{GIoU}$ is the Generalized IoU loss.
