...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=12.5cm]{images/kalmannet2.jpg}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=8cm]{images/kalmannet1.jpg}
...
The Viola Jones (VJ) detector \cite{vjdet} was a breakthrough algorithm that is considered to be the first viable real time object detector whilst still maintaining state-of-the-art accuracy. Although it targets face detection, it can be equally applied to different object classes.
