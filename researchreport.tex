...
\caption{Detection dataset ball positions}
...
The dataset is interrogated in order to understand and sanity check the acquired data. Table \ref{tab:tracking} shows a break down of various sequence properties. 

\begin{table*}[h!]
\fontsize{9.5pt}{12pt}\selectfont
\centering
\begin{tabular}{c|ll|l|ll}
{\bf Dataset}	&{\bf Kicks}	&{\bf Split}	&{\bf Timesteps}	&{\bf Grounded}	&{\bf Lofted}	\\\hline
Total			&370			&100\%			&370			&20.3\%			&79.7\%			\\\hline   
Train			&222			&60\%			&370			&21.2\%			&78.8\%			\\\hline  
Validation		&74				&20\%			&370			&17.8\%			&82.2\%			\\\hline  
Test			&74				&20\%			&370			&20.0\%			&80.0\%			\\\hline                        
\end{tabular}
