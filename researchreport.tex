...
Quantization can potentially reduce the memory footprint of a model. The effect of quantization on the inference performance is now evaluated.

\begin{figure}[h!]
\begin{center}
\includegraphics[width=10cm]{images/nanodet_compare.png}
\caption{Effect of model quantization}
\label{fig:evalquant}
\end{center}
\end{figure}
