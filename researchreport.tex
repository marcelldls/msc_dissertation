...
It can be recognized that, per kick, initially more accurate detections are available and as the ball moves further away from the agent that the detections become significantly less accurate. Since a the EKF model attempts to account for the nonlinear trajectory after kicking, one might rather focus having early detections dominate the initial converging on the state and then allow the model predictions to dominate the state estimation and possibly even ignoring detections as they become less reliable. In order to achieve this, one might tune the measurement noise factor in order to get this behavior. Although gain scheduling is also possible, however, it is desired to rather retain the natural initialization behavior.

\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm]{images/ekfg_ground_short.png}
\caption{Short ground kick - EKF hand crafted}
\label{fig:ekfggroundshort}
\end{center}
\end{figure}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm]{images/ekfg_ground_long.png}
\caption{Long ground kick - EKF hand crafted}
\label{fig:ekfggroundlong}
\end{center}
\end{figure}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm]{images/ekfg_loft_short.png}
\caption{Short lofted kick - EKF hand crafted}
\label{fig:ekfgloftshort}
\end{center}
\end{figure}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm]{images/ekfg_loft_long.png}
\caption{Long lofted kick - EKF hand crafted}
\label{fig:ekfgloftlong}
\end{center}
\end{figure}

In this manner it is possible to hand craft the gains in order to get better results. 
...
\begin{center}
\includegraphics[width=13cm]{images/ekf_error.png}
\caption{Extended Kalman Filter error this plot is wrong}
\label{fig:ekferror}
\end{center}
\end{figure}
