...
Although neural Kalman filtering was able to outperform the traditional tracking methods as measured by mean square error -- some of the characteristics are undesirable for control purposes. One issue is that within the reliable range of the object detector, the traditional methods out perform the neural based approach. 

 Focal loss based on distance as. Penalty for jitter may be harmful. A possible approach is using the EKF.
